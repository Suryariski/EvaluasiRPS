    ...
    <div class="scrollbar-inner">
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link active " href="mahasiswa/index.php">
            ...
            <li class="nav-item">
              <a class="nav-link" href="../examples/progamstudi/programstudi2.php">
                <i class="ni ni-bullet-list-67 text-default"></i>
            ...
            <li class="nav-item">
              <a class="nav-link active" href="../examples/rpsdetail/rpsdetail2.php">
                <i class="ni ni-bullet-list-67 text-default"></i>
