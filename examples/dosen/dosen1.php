          ...
          <ul class="navbar-nav align-items-center  ml-auto ml-md-0 ">
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu  dropdown-menu-right ">
                ...
                <a href="examples/logout" class="dropdown-item">
    ...
    <div class="container-fluid mt--6">
      ...
      <div class="row">
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <a href="register.php"><button class="btn btn-primary">Tambah Dosen</button></a>
            </div>
            <!-- Light table -->
              ...
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th scope="col" class="sort" data-sort="status">NIDN</th>
            ...
            for($i=1; $i<=$jmlhalaman; $i++)
                if ($i != $halaman) {
                    echo " <a href=\"dosen.php?halaman=$i\">$i</a> | ";
                } else {
                    echo "<b>$i</b> | ";
                }
            echo "<p>Total anggota : <b>$jmldata</b> orang</p>";
            $query = "SELECT user.*,dosen.*,programstudi.* FROM user inner join dosen using(userid) inner join programstudi using(kodeprodi)  LIMIT $posisi,$batas";
        ...
        <tr>
            ...
            <td>
                <a href="editt.php?userid=<?php echo $d['userid'];?>"><button class="btn btn-info">Edit</button></a>
                <a href="hapus.php?userid=<?php echo $d['userid'];?>"><button class="btn btn-danger">Hapus</button></a>
            </td>
        </tr>
        <?php
            }
