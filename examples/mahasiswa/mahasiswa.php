      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="../mahasiswa/Mahasiswa.php">
                <i class="ni ni-bullet-list-67 text-default"></i>
    ...
    <div class="container-fluid mt--6">
      ...
      <div class="row">
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <a href="register.php"><button class="btn btn-primary">Tambah Mahasiswa</button></a>
            </div>
            <!-- Light table -->
              ...
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th scope="col" class="sort" data-sort="status">Nama Mahasiswa</th>
                    <th scope="col">Alamat</th>
                    <th scope="col" class="sort" data-sort="status">No Telp</th>
                    <th scope="col" class="sort" data-sort="status">Tahun Di Terima</th>
                    <th scope="col" class="sort" data-sort="status">User ID</th>
            ...
            for($i=1; $i<=$jmlhalaman; $i++)
                if ($i != $halaman) {
                    echo " <a href=\"mahasiswa.php?halaman=$i\">$i</a> | ";
                } else {
                    echo "<b>$i</b> | ";
                }
            echo "<p>Total anggota : <b>$jmldata</b> orang</p>";
            $query = "SELECT user.*, mahasiswa.*,programstudi.* FROM user inner join mahasiswa using(userid) inner join programstudi using(kodeprodi)  LIMIT $posisi,$batas";
        ...
        <tr>
            ...
            <td><?php echo $d['namamahasiswa']; ?></td>
            ...
            <td>
                <a href="edit.php?userid=<?php echo $d['userid']; ?>"><button class="btn btn-info">Edit</button></a>
                <a href="hapusmhs.php?userid=<?php echo $d['userid']; ?>"><button class="btn btn-danger">Hapus</button></a>
            </td>
        </tr>
        <?php
            }
