      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="../rps/rps.php">
                <i class="ni ni-bullet-list-67 text-default"></i>
    ...
    <div class="container-fluid mt--6">
      ...
      <div class="row">
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <a href="register.php"><button class="btn btn-primary">Tambah RPS</button></a>
            </div>
            <!-- Light table -->
            ...
            for($i=1; $i<=$jmlhalaman; $i++)
                if ($i != $halaman) {
                    echo " <a href=\"rps.php?halaman=$i\">$i</a> | ";
                } else {
                    echo "<b>$i</b> | ";
                }
        ...
        <tr>
            ...
            <td>
                <a href="editt.php?noidrps=<?php echo $d['noidrps']; ?>"><button class="btn btn-info">Edit</button></a>
                <a href="hapus.php?noidrps=<?php echo $d['noidrps']; ?>"><button class="btn btn-danger">Hapus</button></a>
            </td>
        </tr>
        <?php
            }
