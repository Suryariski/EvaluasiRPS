      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="progamstudi.php">
                <i class="ni ni-bullet-list-67 text-default"></i>
            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item"><a href="#">Progam Studi</a></li>
                </ol>
              </nav>
            </div>
          </div>
    ...
    <div class="container-fluid mt--6">
      ...
      <div class="row">
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <a href="register.php"><button class="btn btn-primary">Tambah Progam Studi</button></a>
            </div>
            <!-- Light table -->
              ...
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th scope="col" class="sort" data-sort="budget">Kode Prodi</th>
                    <th scope="col" class="sort" data-sort="status">Nama Prodi</th>
            ...
            $query2      = mysqli_query($koneksi, "SELECT * FROM programstudi");
            $jmldata    = mysqli_num_rows($query2);
            $jmlhalaman = ceil($jmldata/$batas);
            echo "<br> Halaman : ";
            for($i=1; $i<=$jmlhalaman; $i++)
                if ($i != $halaman) {
                    echo " <a href=\"progamstudi.php?halaman=$i\">$i</a> | ";
                } else {
                    echo "<b>$i</b> | ";
                }
            echo "<p>Total anggota : <b>$jmldata</b> orang</p>";
            $query = "SELECT * FROM programstudi  LIMIT $posisi,$batas";
        ...
        <tr>
            ...
            <td><?php echo $no++; ?></td>
            <td><?php echo $d['kodeprodi']; ?></td>
            <td><?php echo $d['namaprodi']; ?></td>
            <td><?php echo $d['nipkaprodi']; ?></td>
            <td>
                <a href="editt.php?kodeprodi=<?php echo $d['kodeprodi']; ?>"><button class="btn btn-info">Edit</button></a>
                <a href="hapus.php?kodeprodi=<?php echo $d['kodeprodi']; ?>"><button class="btn btn-danger">Hapus</button></a>
            </td>
        </tr>
        <?php
            }
