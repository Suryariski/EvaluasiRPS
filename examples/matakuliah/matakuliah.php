    ...
    <div class="container-fluid mt--6">
      ...
      <div class="row">
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <a href="register.php"><button class="btn btn-primary">Tambah Mata Kuliah</button></a>
            </div>
            <!-- Light table -->
            ...
            for($i=1; $i<=$jmlhalaman; $i++)
                if ($i != $halaman) {
                    echo " <a href=\"matakuliah.php?halaman=$i\">$i</a> | ";
                } else {
                    echo "<b>$i</b> | ";
                }
        ...
        <tr>
            ...
            <td>
                <a href="editt.php?kodemk=<?php echo $d['kodemk']; ?>"><button class="btn btn-info">Edit</button></a>
                <a href="hapus.php?kodemk=<?php echo $d['kodemk']; ?>"><button class="btn btn-danger">Hapus</button></a>
            </td>
        </tr>
        <?php
            }
